...
var pages = 864;
//Using console.log(bookTitle, pages); should print out Anna Karenina 864
...
var pages = pages/4;
//Using console.log(bookTitle, pages); this time should print out Anna Karenina 216
...
var sequel = `${bookTitle}: Part II`;
// Using console.log(sequel); should print out Anna Karenina: Part II

// Initialize a new variable "isFavorite", and assign it to a boolean value indicating
// if the book you chose is your favorite book or not
var isFavorite = false;
// Using console.log(isFavorite); should print out false
...
//If we added console.log(isShortStory);
//This code should print out the value of false if var pages = 864
...
dictionary.pageCount = 720;
 ...
 // Using console.log(dictionary); should print out { name: "Webster's", hasThesaurus: false, pagecount: 720 }
